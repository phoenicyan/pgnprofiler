//
// File is copied from https://github.com/tringi/win32-iocp-events
//
...
_Success_ (return != FALSE) BOOL WINAPI RemoveUnlimitedWaitObject (
    _In_ UnlimitedWait* instance,
    _In_ HANDLE hObjectHandle,
...
static BOOL WINAPI WaitUnlimitedWaitExImplementation (
    _In_ UnlimitedWait* instance,
